...
from rdkit.Chem import AddHs, GetMolFrags, Kekulize, MolToInchi, MolFromInchi, MolFromSmarts, MolFromSmiles, \
    RemoveStereochemistry, RemoveHs
...
class Filters(object):
    ...
    def keep_biggest(cls, mol_in):
        ...
        if len(molfrag) > 1:
            ...
            accepted_mass = 0  # flag the molecular weight of the biggest fragment
            for f in molfrag:
    ...
    def _neutralise_charge_method1(cls, mol_in, rules=None):
        ...
        for reactant, product in rules.rules:
